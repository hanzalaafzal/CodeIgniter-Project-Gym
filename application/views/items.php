                          ...
                          if($items->num_rows()>0)
                          {
                            foreach($items->result() as $item)
                            {
                              ...
                              <td class="text-right">
                                    ...
                                    <button type="button" onclick="del_item(<?php echo $item->id ?>,'<?php echo $item->name ?>')" class="btn btn-link btn-warning btn-just-icon remove"><i class="material-icons">close</i>
