            ...
            <form class="form" method="POST" action="<?php echo base_url('Auth/auth') ?>">
              <div class="card card-login card-hidden">
                ...
                <div class="card-body ">
                  ...
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="text" name="ad_email" class="form-control" placeholder="Username...">
                    </div>
                  </span>
                  <span class="bmd-form-group">
                    <div class="input-group">
                ...
                <div class="card-footer justify-content-center">
                  <button type="submit btn" name="btn_login" class="btn btn-rose btn-link btn-lg">Login</button>
                </div>
              </div>
            </form>
          </div>
